package cn.yan.study.springboot.netty.standard;

import cn.yan.study.springboot.netty.annotation.ServerEndpoint;
import cn.yan.study.springboot.netty.exception.DeploymentException;
import cn.yan.study.springboot.netty.pojo.PojoEndpointServer;
import cn.yan.study.springboot.netty.pojo.PojoMethodMapping;
    ...
    private void init() {
        for (Map.Entry<InetSocketAddress, WebSocketServer> entry : addressWebsocketServerMap.entrySet()) {
            ...
            try {
                ...
                logger.error("netty [" + entry.getKey() + "] init fail", e);
            }
        }
    }
