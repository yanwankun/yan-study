package cn.yan.study.websocket.mychat.generator;
...
//        gc.setOutputDir("D://workspace/spring-boot-mybatis/src/main/java");
        ...
        dsc.setPassword("yan432464");
        dsc.setUrl("jdbc:mysql://118.24.150.85:3306/myChat?useUnicode=true&characterEncoding=utf8");
...
//        strategy.setInclude(new String[] { "tb_my_chat_user" }); // 需要生成的表
        strategy.setInclude(new String[] { "tb_my_chat_msg" }); // 需要生成的表
