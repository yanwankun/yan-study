...
//        WebSocketChatClient chatclient = new WebSocketChatClient( new URI( "wss://www.alidaughter.cn:8443/netty" ) );
        WebSocketChatClient chatclient = new WebSocketChatClient( new URI( "wss://geex.vip:8443/netty" ) );
